...
async function triggerLiveUserEvent() {
    ...
    if (liveUsers.length) {
        for (let i in liveUsers) {  
            ...
            const twitchUrl = `https://player.twitch.tv/?channel=${liveUsers[i].twitchUsername}&parent=fancy-valued-goat.ngrok-free.app&parent=todocalc-8633c.web.app&parent=localhost&parent=cis-0cz9.onrender.com`;
            const data = {
                twitchUrl,
